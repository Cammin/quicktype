...
namespace QuickType
{
    ...
    public partial class Ldtk
    {
        public static Ldtk FromJson(string json) => JsonSerializer.Deserialize<Ldtk>(json, QuickType.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Ldtk self) => JsonSerializer.Serialize(self, QuickType.Converter.Settings);
    }
