...
export const spanjsonCSharpOptions = Object.assign({}, cSharpOptions, {
...
export class SystemTextJsonCSharpTargetLanguage extends CSharpTargetLanguage {
    constructor() {
        super("C# (System.Text.Json)", ["csstj", "csharp"], "cs");
    }

    protected getOptions(): Option<any>[] {
        return [
            spanjsonCSharpOptions.namespace,
            spanjsonCSharpOptions.version,
            spanjsonCSharpOptions.dense,
            spanjsonCSharpOptions.useList,
            spanjsonCSharpOptions.useDecimal,
            spanjsonCSharpOptions.features,
            spanjsonCSharpOptions.checkRequired,
            spanjsonCSharpOptions.typeForAny,
            spanjsonCSharpOptions.baseclass,
            spanjsonCSharpOptions.virtual
        ];
    }
    ...
    ): SpanJsonCSharpRenderer {
        return new SpanJsonCSharpRenderer(
            this,
            renderContext,
            getOptionValues(spanjsonCSharpOptions, untypedOptionValues)
        );
    }
}

export class SpanJsonCSharpRenderer extends CSharpRenderer {
    ...
    constructor(
        targetLanguage: TargetLanguage,
        renderContext: RenderContext,
        private readonly _options: OptionValues<typeof spanjsonCSharpOptions>
    ) {
