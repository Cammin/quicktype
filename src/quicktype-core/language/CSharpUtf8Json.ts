...
export const utf8jsonCSharpOptions = Object.assign({}, cSharpOptions, {
...
export class Utf8JsonCSharpTargetLanguage extends CSharpTargetLanguage {
    constructor() {
        super("C# (Utf8Json)", ["csstj", "csharp"], "cs");
    }

    protected getOptions(): Option<any>[] {
        return [
            utf8jsonCSharpOptions.namespace,
            utf8jsonCSharpOptions.version,
            utf8jsonCSharpOptions.dense,
            utf8jsonCSharpOptions.useList,
            utf8jsonCSharpOptions.useDecimal,
            utf8jsonCSharpOptions.features,
            utf8jsonCSharpOptions.checkRequired,
            utf8jsonCSharpOptions.typeForAny,
            utf8jsonCSharpOptions.baseclass,
            utf8jsonCSharpOptions.virtual
        ];
    }
    ...
    ): Utf8JsonCSharpRenderer {
        return new Utf8JsonCSharpRenderer(
            this,
            renderContext,
            getOptionValues(utf8jsonCSharpOptions, untypedOptionValues)
        );
    }
}

export class Utf8JsonCSharpRenderer extends CSharpRenderer {
    ...
    constructor(
        targetLanguage: TargetLanguage,
        renderContext: RenderContext,
        private readonly _options: OptionValues<typeof utf8jsonCSharpOptions>
    ) {
    ...
    protected emitUsings(): void {
        ...
        for (const ns of ["Utf8Json", "System.Runtime.Serialization"]) {
            this.emitUsing(ns);
        }

        if (this._options.dense) {
            this.emitUsing([denseJsonPropertyName, " = System.Runtime.Serialization.DataMember"]);
            // this.emitUsing([denseRequiredEnumName, " = Newtonsoft.Json.Required"]);
            this.emitUsing([denseNullValueHandlingEnumName, " = System.Runtime.Serialization.IgnoreDataMember"]);
        }
    ...
    protected attributesForProperty(
        ...
        attributes.push(["[", jsonPropertyName, '(Name = "', escapedName, '")]']);
    ...
    private emitFromJsonForTopLevel(t: Type, name: Name): void {
        ...
        this.emitType(undefined, AccessModifier.Public, [partial, typeKind], name, this.baseclassForType(t), () => {
            ...
            this.emitExpressionMember(
                ...
                ["JsonSerializer.Deserialize<", csType, ">(json)"]
            );
        });
    }
        ...
        this.emitType(undefined, AccessModifier.Public, "static class", "Serialize", undefined, () => {
            ...
            this.forEachTopLevel("none", t => {
                ...
                if (!seenTypes.has(t)) {
                    seenTypes.add(t);
                    this.emitExpressionMember(
                        ["public static byte[] ToJson(this ", this.topLevelResultType(t), " self)"],
